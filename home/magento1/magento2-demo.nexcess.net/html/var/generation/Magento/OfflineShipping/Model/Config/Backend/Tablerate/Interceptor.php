<?php
namespace Magento\OfflineShipping\Model\Config\Backend\Tablerate;

/**
 * Interceptor class for @see
 * \Magento\OfflineShipping\Model\Config\Backend\Tablerate
 */
class Interceptor extends \Magento\OfflineShipping\Model\Config\Backend\Tablerate implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $tablerateFactory, $resource, $resourceCollection, $data);
    }
