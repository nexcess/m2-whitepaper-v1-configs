...
class Interceptor extends \Magento\Catalog\Block\Product\Widget\NewWidget implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getProductsPerPage()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getProductsPerPage', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function showPager()
    {
        ...
        if (!$pluginInfo) {
            return parent::showPager();
        } else {
            return $this->___callPlugins('showPager', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setProductsCount');
        if (!$pluginInfo) {
            return parent::setProductsCount($count);
        } else {
            return $this->___callPlugins('setProductsCount', func_get_args(), $pluginInfo);
        }
    }
