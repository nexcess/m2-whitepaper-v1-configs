<?php
namespace Magento\Catalog\Model\Session;

/**
 * Proxy class for @see \Magento\Catalog\Model\Session
 */
class Proxy extends \Magento\Catalog\Model\Session implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Catalog\\Model\\Session', $shared = true)
    {
