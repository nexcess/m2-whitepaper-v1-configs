...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Websites implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasWebsite');
        if (!$pluginInfo) {
            return parent::hasWebsite($websiteId);
        } else {
            return $this->___callPlugins('hasWebsite', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoreName($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreName($storeId);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChooseFromStoreHtml');
        if (!$pluginInfo) {
            return parent::getChooseFromStoreHtml($storeTo);
        } else {
            return $this->___callPlugins('getChooseFromStoreHtml', func_get_args(), $pluginInfo);
        }
    }
