 ...
 * \Magento\GoogleAdwords\Model\Config\Backend\ConversionId
 */
class Interceptor extends \Magento\GoogleAdwords\Model\Config\Backend\ConversionId implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getConversionId()
    {
        ...
        if (!$pluginInfo) {
            return parent::getConversionId();
        } else {
            return $this->___callPlugins('getConversionId', func_get_args(), $pluginInfo);
        }
    }
