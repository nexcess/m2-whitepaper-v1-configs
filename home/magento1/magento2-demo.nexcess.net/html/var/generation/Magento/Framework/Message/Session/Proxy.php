<?php
namespace Magento\Framework\Message\Session;

/**
 * Proxy class for @see \Magento\Framework\Message\Session
 */
class Proxy extends \Magento\Framework\Message\Session implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Framework\\Message\\Session', $shared = true)
    {
     ...
     *
     * @return \Magento\Framework\Message\Session
     */
