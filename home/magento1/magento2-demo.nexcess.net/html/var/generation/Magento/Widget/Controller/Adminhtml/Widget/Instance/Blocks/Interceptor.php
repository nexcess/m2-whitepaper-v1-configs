<?php
namespace Magento\Widget\Controller\Adminhtml\Widget\Instance\Blocks;

/**
 * Interceptor class for @see
 * \Magento\Widget\Controller\Adminhtml\Widget\Instance\Blocks
 */
class Interceptor extends \Magento\Widget\Controller\Adminhtml\Widget\Instance\Blocks implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderPageContainers');
        if (!$pluginInfo) {
            return parent::renderPageContainers();
        } else {
            return $this->___callPlugins('renderPageContainers', func_get_args(), $pluginInfo);
        }
    }
