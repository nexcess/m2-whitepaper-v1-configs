<?php
namespace Magento\Bundle\Controller\Adminhtml\Bundle\Product\Edit\MassStatus;

/**
 * Interceptor class for @see
 * \Magento\Bundle\Controller\Adminhtml\Bundle\Product\Edit\MassStatus
 */
class Interceptor extends \Magento\Bundle\Controller\Adminhtml\Bundle\Product\Edit\MassStatus implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function _validateMassStatus(array $productIds, $status)
    {
        ...
        if (!$pluginInfo) {
            return parent::_validateMassStatus($productIds, $status);
        } else {
            return $this->___callPlugins('_validateMassStatus', func_get_args(), $pluginInfo);
        }
    }
