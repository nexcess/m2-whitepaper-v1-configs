<?php
namespace Magento\CatalogInventory\Model\System\Config\Backend\Minsaleqty;

/**
 * Interceptor class for @see
 * \Magento\CatalogInventory\Model\System\Config\Backend\Minsaleqty
 */
class Interceptor extends \Magento\CatalogInventory\Model\System\Config\Backend\Minsaleqty implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $catalogInventoryMinsaleqty, $resource, $resourceCollection, $data);
    }
