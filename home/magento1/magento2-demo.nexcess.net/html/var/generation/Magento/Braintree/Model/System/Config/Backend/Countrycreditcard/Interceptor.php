<?php
namespace Magento\Braintree\Model\System\Config\Backend\Countrycreditcard;

/**
 * Interceptor class for @see
 * \Magento\Braintree\Model\System\Config\Backend\Countrycreditcard
 */
class Interceptor extends \Magento\Braintree\Model\System\Config\Backend\Countrycreditcard implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $mathRandom, $resource, $resourceCollection, $data);
    }
