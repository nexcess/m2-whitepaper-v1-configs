<?php
namespace Magento\Customer\Model\Config\Share;

/**
 * Interceptor class for @see \Magento\Customer\Model\Config\Share
 */
class Interceptor extends \Magento\Customer\Model\Config\Share implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $storeManager, $customerResource, $resource, $resourceCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isGlobalScope');
        if (!$pluginInfo) {
            return parent::isGlobalScope();
        } else {
            return $this->___callPlugins('isGlobalScope', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isWebsiteScope');
        if (!$pluginInfo) {
            return parent::isWebsiteScope();
        } else {
            return $this->___callPlugins('isWebsiteScope', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSharedWebsiteIds($websiteId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSharedWebsiteIds($websiteId);
        } else {
