...
/**
 * Proxy class for @see \Magento\Customer\Model\Config\Share
 */
class Proxy extends \Magento\Customer\Model\Config\Share implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Customer\\Model\\Config\\Share', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->isGlobalScope();
    }
    ...
    {
        return $this->_getSubject()->isWebsiteScope();
    }
    ...
    {
        return $this->_getSubject()->getSharedWebsiteIds($websiteId);
    }
    ...
    {
        return $this->_getSubject()->getOldValue();
    }
    ...
    {
        return $this->_getSubject()->getFieldsetDataValue($key);
    }
