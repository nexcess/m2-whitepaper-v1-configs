...
/**
 * Proxy class for @see \Magento\MediaStorage\Model\File\Storage
 */
class Proxy extends \Magento\MediaStorage\Model\File\Storage implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\MediaStorage\\Model\\File\\Storage', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->getSyncFlag();
    }
    ...
    {
        return $this->_getSubject()->getStorageModel($storage, $params);
    }
    ...
    {
        return $this->_getSubject()->synchronize($storage);
    }
    ...
    {
        return $this->_getSubject()->getScriptConfig();
    }
