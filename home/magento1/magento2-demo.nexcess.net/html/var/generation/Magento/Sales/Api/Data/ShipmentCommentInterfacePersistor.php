...
class ShipmentCommentInterfacePersistor
{
     ...
     *
     * @param \Magento\Sales\Model\Spi\ShipmentCommentResourceInterface
     * $shipmentCommentInterfaceResource
     * @param \Magento\Sales\Api\Data\ShipmentCommentInterfaceFactory
     * $shipmentCommentInterfaceFactory
            ...
            do {
                ...
                if (isset($this->entitiesPool[$hash])) {
                    ...
                    if ($data['action'] == 'created') {
                        $this->shipmentCommentInterfaceResource->save($data['entity']);
                        $ids[] = $data['entity']->getId();
                    } else {
                        $ids[] = $data['entity']->getId();
                        $this->shipmentCommentInterfaceResource->delete($data['removed']);
                    }
                }
