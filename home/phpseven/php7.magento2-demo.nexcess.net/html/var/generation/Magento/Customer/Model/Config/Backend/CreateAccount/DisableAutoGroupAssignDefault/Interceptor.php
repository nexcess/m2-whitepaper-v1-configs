<?php
namespace Magento\Customer\Model\Config\Backend\CreateAccount\DisableAutoGroupAssignDefault;

/**
 * Interceptor class for @see
 * \Magento\Customer\Model\Config\Backend\CreateAccount\DisableAutoGroupAssignDefault
 */
class Interceptor extends \Magento\Customer\Model\Config\Backend\CreateAccount\DisableAutoGroupAssignDefault implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $eavConfig, $resource, $resourceCollection, $data);
    }
