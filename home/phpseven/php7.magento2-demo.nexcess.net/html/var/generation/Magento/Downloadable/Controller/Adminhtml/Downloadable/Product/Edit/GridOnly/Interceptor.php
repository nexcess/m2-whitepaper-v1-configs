<?php
namespace Magento\Downloadable\Controller\Adminhtml\Downloadable\Product\Edit\GridOnly;

/**
 * Interceptor class for @see
 * \Magento\Downloadable\Controller\Adminhtml\Downloadable\Product\Edit\GridOnly
 */
class Interceptor extends \Magento\Downloadable\Controller\Adminhtml\Downloadable\Product\Edit\GridOnly implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $productBuilder, $resultRawFactory, $layoutFactory);
    }
