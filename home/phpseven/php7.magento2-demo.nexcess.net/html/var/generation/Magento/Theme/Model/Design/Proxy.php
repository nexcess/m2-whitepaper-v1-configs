...
/**
 * Proxy class for @see \Magento\Theme\Model\Design
 */
class Proxy extends \Magento\Theme\Model\Design implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Theme\\Model\\Design', $shared = true)
    {
     ...
     *
     * @return \Magento\Theme\Model\Design
     */
    ...
    {
        return $this->_getSubject()->loadChange($storeId, $date);
    }
    ...
    {
        return $this->_getSubject()->changeDesign($packageInto);
    }
