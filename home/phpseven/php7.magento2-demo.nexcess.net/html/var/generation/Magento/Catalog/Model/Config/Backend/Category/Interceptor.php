<?php
namespace Magento\Catalog\Model\Config\Backend\Category;

/**
 * Interceptor class for @see \Magento\Catalog\Model\Config\Backend\Category
 */
class Interceptor extends \Magento\Catalog\Model\Config\Backend\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $catalogCategory, $resource, $resourceCollection, $data);
    }
