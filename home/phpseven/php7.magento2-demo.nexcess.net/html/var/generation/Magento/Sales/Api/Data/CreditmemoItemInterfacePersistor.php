...
class CreditmemoItemInterfacePersistor
{
     ...
     *
     * @param \Magento\Sales\Model\Spi\CreditmemoItemResourceInterface
     * $creditmemoItemInterfaceResource
     * @param \Magento\Sales\Api\Data\CreditmemoItemInterfaceFactory
     * $creditmemoItemInterfaceFactory
            ...
            do {
                ...
                if (isset($this->entitiesPool[$hash])) {
                    ...
                    if ($data['action'] == 'created') {
                        $this->creditmemoItemInterfaceResource->save($data['entity']);
                        $ids[] = $data['entity']->getId();
                    } else {
                        $ids[] = $data['entity']->getId();
                        $this->creditmemoItemInterfaceResource->delete($data['removed']);
                    }
                }
