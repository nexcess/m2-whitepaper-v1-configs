...
class ShipmentItemInterfacePersistor
{
     ...
     *
     * @param \Magento\Sales\Model\Spi\ShipmentItemResourceInterface
     * $shipmentItemInterfaceResource
     * @param \Magento\Sales\Api\Data\ShipmentItemInterfaceFactory
     * $shipmentItemInterfaceFactory
            ...
            do {
                ...
                if (isset($this->entitiesPool[$hash])) {
                    ...
                    if ($data['action'] == 'created') {
                        $this->shipmentItemInterfaceResource->save($data['entity']);
                        $ids[] = $data['entity']->getId();
                    } else {
                        $ids[] = $data['entity']->getId();
                        $this->shipmentItemInterfaceResource->delete($data['removed']);
                    }
                }
