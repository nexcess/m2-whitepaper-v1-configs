...
/**
 * Proxy class for @see \Magento\Weee\Model\Tax
 */
class Proxy extends \Magento\Weee\Model\Tax implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Weee\\Model\\Tax', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->getWeeeAmount($product, $shipping, $billing, $website, $calculateTax);
    }
    ...
    {
        return $this->_getSubject()->getWeeeAmountExclTax($product, $shipping, $billing, $website);
    }
    ...
    {
        return $this->_getSubject()->getWeeeAttributeCodes($forceEnabled);
    }
    ...
    {
        return $this->_getSubject()->getWeeeTaxAttributeCodes($store, $forceEnabled);
    }
    ...
    {
        return $this->_getSubject()->getProductWeeeAttributes($product, $shipping, $billing, $website, $calculateTax, $round);
    }
    ...
    {
        return $this->_getSubject()->isWeeeInLocation($countryId, $regionId, $websiteId);
    }
