...
class Interceptor extends \Magento\Wishlist\Block\Share\Wishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistCustomer');
        if (!$pluginInfo) {
            return parent::getWishlistCustomer();
        } else {
            return $this->___callPlugins('getWishlistCustomer', func_get_args(), $pluginInfo);
        }
    }
