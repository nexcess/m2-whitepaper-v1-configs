...
class Interceptor extends \Magento\GroupedProduct\Block\Adminhtml\Product\Composite\Fieldset\Grouped implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsLastFieldset');
        if (!$pluginInfo) {
            return parent::getIsLastFieldset();
        } else {
            return $this->___callPlugins('getIsLastFieldset', func_get_args(), $pluginInfo);
        }
    }
